    ...
    <main className="flex-1 p-6 relative z-10 mb-20">
        <div className="max-w-5xl mx-auto mt-10">
          ...
          <p className="mb-10 text-white/70">
            Actividades practicas para reforzar tu aprendizaje.
          </p>
          ...
          <ul className="space-y-4">
            ...
            >
              <h2 className="text-xl text-white font-semibold">Actividad de Apoyo Financiero</h2>
              <p className="text-white/70 mt-2">Practica sobre conceptos de financiamiento estudiantil</p>
            </li>
          </ul>
          ...
          <ul className="space-y-4">
            ...
            >
              <h2 className="text-xl text-white font-semibold">Actividad de Vinculacion Laboral</h2>
              <p className="text-white/70 mt-2">Ejercicios sobre convenios y practicas profesionales</p>
            </li>
          </ul>
